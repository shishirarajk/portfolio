...
const Navbar = () => {
  return (
    <nav className="mb-0 md:mb-10 lg:mb-10 flex items-center justify-between py-6">
      <div className="flex flex-shrink-0 items-center">
        <p className="text-purple-400 font-bold text-lg">Srk</p>
      </div>

      <div className="m-0 md:m-8 lg:m-8 flex items-center justify-center gap-4 text-2xl">
